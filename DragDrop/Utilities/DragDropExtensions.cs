...
namespace CodingDad.NET.Common.DragDrop.Utilities
{
    public static class DragDropExtensions
    {
        ...
        {
            return element != null && DragDropMain.GetIsDragSource(element);
        }
        ...
        {
            return element != null && DragDropMain.GetDragSourceIgnore(element);
        }
        ...
        {
            return element != null && DragDropMain.GetIsDropTarget(element);
        }
