...
namespace CodingDad.NET.Common.DragDrop.Drop
{
    ...
    public class DefaultDropHandler : IDropTarget
    {
        ...
        /// <exception cref="ArgumentNullException"><paramref name="dropInfo" /> is <see langword="null" /></exception>
        /// <exception cref="ArgumentNullException"><paramref name="dropInfo" /> is <see langword="null" /></exception>
        public static void SelectDroppedItems (IDropInfo dropInfo, IEnumerable items, bool applyTemplate = true, bool focusVisualTarget = true)
        {
            ...
            if (dropInfo.VisualTarget is ItemsControl itemsControl)
            {
                ...
                var selectDroppedItems = dropInfo.VisualTarget is TabControl || dropInfo.VisualTarget != null && DragDropMain.GetSelectDroppedItems(dropInfo.VisualTarget);
